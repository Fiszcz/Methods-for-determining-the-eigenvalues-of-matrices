...
printstyled("Matrix 5x5:\n", color = :(blue))
display(@benchmark powerMethodWithDeflation($matrix5x5))
printstyled("Matrix 25x25:\n", color = :(blue))
display(@benchmark powerMethodWithDeflation($matrix25x25))
printstyled("Matrix 75x75:\n", color = :(blue))
display(@benchmark powerMethodWithDeflation($matrix75x75))
printstyled("Matrix 150x150:\n", color = :(blue))
display(@benchmark powerMethodWithDeflation($matrix150x150))
